...
export class SingleHoodiePage extends BasePage {
    ...
    //private hoodie_size = By.xpath("//div[@class='product-variation-container']//div[@class='product-variation-content ']//ul[@class='product-variation-swatches product-variation--size']//a[@href='https://eu.puma.com/de/en/pd/ess%2B-minimal-gold-womens-hoodie/680019.html?dwvar_680019_size=0130&dwvar_680019_color=01']"); //S is no longer available
    private hoodie_size = By.xpath("//div[@class='product-variation-container']//div[@class='product-variation-content ']//ul[@class='product-variation-swatches product-variation--size']//a[@href='https://eu.puma.com/de/en/pd/ess%2B-minimal-gold-womens-hoodie/680019.html?dwvar_680019_size=0140&dwvar_680019_color=01']");
    ...
    async chooseHoodieSize(){
        ...
        //await this.driver.manage().setTimeouts({ implicit: 10000 }); //does not work here
